...
const Projects = () => {
  return (
    <div>
      ...
      <div id="projects" className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5 lg:w-[80%] mx-auto my-7">

        <div className="card  card-compact  bg-base-100 shadow-purple-600 shadow-xl">
          <img className="h-[200px] object-cover" src={img1} alt="" />
          <div className="card-body ">
            ...
            <div>
              <h1 className="text-black  font-semibold">Website Technologies which i have used <span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,<br />express,tanstack query ,<br />react-hook-form,react-router,JWT</span></h1>
            </div>
        ...
        <div className="card  card-compact  bg-base-100 shadow-purple-600 shadow-xl">
          <img className="h-[200px] object-cover" src={img2} alt="" />
          <div className="card-body ">
            ...
            <p className="text-black font-semibold">Website Technologies which i have used :<span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,<br />react-router, JWT</span></p>
            <div className="card-actions space-x-4 ">
        ...
        <div className="card  card-compact  bg-base-100 shadow-purple-600 shadow-xl">
          <img className="h-[200px] object-cover" src={img3} alt="" />
          <div className="card-body ">
            <h2 className="card-title text-2xl text-purple-600">Glamour & Grace</h2>
            <p>It is a contest competetion website.Any one can participate any contest by pay registration fee.</p>
            <p className="text-black font-semibold">Website Technologies which i have used : <span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,<br />react-router </span></p>
