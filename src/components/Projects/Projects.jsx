...
const Projects = () => {
    return (
        <div id="projects" className="grid grid-cols-3 gap-5 w-[90%] mx-auto my-7">
            <div className="card  card-compact  bg-base-100 shadow-purple-600 shadow-xl">
  <img className="h-[200px]" src={img1} alt="" />
  <div className="card-body ">
    <h2 className="card-title">Contest Hub</h2>
    <p>It is a contest competetion website.Any one can participate any contest by pay registration fee.</p>
    <p className="">Website Technologies which i have used : <span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,react-router,express, tanstack query , react-hook-form, JWT</span></p>
...
{/* 2nd  */}
  ...
  <div className="card-body ">
    <h2 className="card-title">Food Love</h2>
    <p>It is a resturent management website.peaople can buy any food item</p>
    <p className="">Website Technologies which i have used : <span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,react-router, JWT</span></p>
    <div className="card-actions gap-10 ">
...
{/* 3rd  */}
  ...
  <div className="card-body ">
    <h2 className="card-title">Glamour & Grace</h2>
    <p>It is a contest competetion website.Any one can participate any contest by pay registration fee.</p>
    <p className="">Website Technologies which i have used : <span className="text-purple-600 text-lg">html, css,tailwind,daisyUi,mongoDb,firebase,react-router </span></p>
    <div className="card-actions gap-10 ">
